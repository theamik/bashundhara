...
const Details = () => {
    ...
    return (
        <div>
            <Headers />
            <div className='bg-[url("https://bashundhara.vercel.app/images/banner/order.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                <div className='absolute left-0 top-0 w-full h-full bg-[#2422228a]'>
                    <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                        <div className='flex flex-col justify-center gap-1 items-center h-full w-full text-white'>
                            <h2 className='text-3xl font-bold'>AleeZa</h2>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    >
                                        {
                                            product.images.map((img, i) => {
                                                return (
                                                    <div key={i} onClick={() => setImage(img)} className='mr-2'>
                                                        <img className='h-[120px] w-[120px]  cursor-pointer' src={img} alt="" />
                                                    </div>
                                                )
                                            })
                                        }
